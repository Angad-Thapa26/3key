...
- Simple browser-based interface, no apps needed
 ...
 Setup Instructions
- Download & Install the 3key.exe file
...
- Use your phone as a remote keypointer to navigate slides 🎉
 ...
 Notes
- Both your PC and mobile must be connected to the same Wi-Fi network
- The server runs only on your local network (safe & private)
- Works best with modern browsers (Chrome, Edge, Firefox)

 Why "3Key"?
Because it gives you the third key to presentations:
UP , DOWN and ENTER

 Quick Demo
Imagine walking around the room, phone in hand, tapping next/previous without being tethered to your laptop. That’s the freedom 3Key brings.
